...
+(UIColor *) COLOUR_BG_NAV_PRIMARY { return [PLConstants LOOKUP_COLOUR4];}
+(UIColor *) COLOUR_BG_NAV_NOTIFICATION { return [PLConstants LOOKUP_COLOUR2];}

#pragma mark colours - labels - navigation

+(UIColor *) COLOUR_LBL_NAV_HEADING { return [PLConstants LOOKUP_COLOUR8];}
+(UIColor *) COLOUR_LBL_NAV_ACTION{ return [PLConstants LOOKUP_COLOUR1];}
...
+ (UIFont *) FONT_NAV_HEADING { return [[PLConstants LOOKUP_FONT1] fontWithSize:38*fontScaleFactor];}
